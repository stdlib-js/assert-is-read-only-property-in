...
```javascript
import isReadOnlyPropertyIn from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-read-only-property-in@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-read-only-property-in/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/assert-is-read-only-property-in/actions/workflows/test.yml?query=branch:v0.2.3

...
```javascript
isReadOnlyPropertyIn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-read-only-property-in@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-read-only-property-in@v0.2.0-umd/browser.js"></script>
```
